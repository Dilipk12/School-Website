      ...
      <div className="flex flex-wrap justify-center items-center gap-5">
        {
          contactData.map((data, i) =>
            <div key={i} className=" flex flex-col items-center justify-center h-44 bg-gray-200 p-8 rounded-md">
              ...
              <div className="">
                ...
                <p className="text-sm font-semibold text-center text-gray-600 w-52">{data.content}</p>
              </div>
            </div>
          )}
