...
function About() {
  return (
    ...
    {/* about of school */}
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8 w-full h-full px-5">
      ...
      <div className="flex justify-center items-center lg:flex-row flex-col-reverse gap-8 w-full h-full px-5 py-5">
